ccflags-y += -D_LUNATIK -D_KERNEL -I$(src) -D_CONFIG_FULL_PANIC -DLUNATIK_UNUSED -I$(src)/lua \
...
lua-memory-objs = deps/lua-memory/src/lmemlib.o deps/lua-memory/src/lmemmod.o

lunatik-objs += $(lua-objs) \
	arch/$(ARCH)/setjmp.o util/modti3.o lunatik_core.o states.o netlink.o $(lua-memory-objs)
